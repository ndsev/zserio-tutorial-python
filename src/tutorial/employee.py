...
class Employee:
    ...
    def from_reader_packed(
            cls: typing.Type['Employee'],
            zserio_context: Employee.ZserioPackingContext,
            zserio_reader: zserio.BitStreamReader) -> 'Employee':
        self = object.__new__(cls)
    ...
    def init_packing_context(self, zserio_context: Employee.ZserioPackingContext) -> None:
        zserio_context.age.init(zserio.array.BitFieldArrayTraits(8), self._age_)
        zserio_context.salary.init(zserio.array.BitFieldArrayTraits(16), self._salary_)
        if self.is_bonus_used():
            zserio_context.bonus.init(zserio.array.BitFieldArrayTraits(16), self._bonus_)
        self._role_.init_packing_context(zserio_context.role)
    ...
    def bitsizeof_packed(self, zserio_context: Employee.ZserioPackingContext, bitposition: int = 0) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.age.bitsizeof(zserio.array.BitFieldArrayTraits(8), self._age_)
        end_bitposition += zserio.bitsizeof.bitsizeof_string(self._name_)
        end_bitposition += zserio_context.salary.bitsizeof(zserio.array.BitFieldArrayTraits(16), self._salary_)
        end_bitposition += 1
        if self.is_bonus_used():
            end_bitposition += zserio_context.bonus.bitsizeof(zserio.array.BitFieldArrayTraits(16), self._bonus_)
        end_bitposition += self._role_.bitsizeof_packed(zserio_context.role, end_bitposition)
        if self.is_skills_used():
    ...
    def initialize_offsets_packed(self, zserio_context: Employee.ZserioPackingContext, bitposition: int) -> int:
        end_bitposition = bitposition
        end_bitposition += zserio_context.age.bitsizeof(zserio.array.BitFieldArrayTraits(8), self._age_)
        end_bitposition += zserio.bitsizeof.bitsizeof_string(self._name_)
        end_bitposition += zserio_context.salary.bitsizeof(zserio.array.BitFieldArrayTraits(16), self._salary_)
        ...
        if self.is_bonus_used():
            end_bitposition += zserio_context.bonus.bitsizeof(zserio.array.BitFieldArrayTraits(16), self._bonus_)
        end_bitposition = self._role_.initialize_offsets_packed(zserio_context.role, end_bitposition)
        if self.is_skills_used():
    ...
    def read_packed(self, zserio_context: Employee.ZserioPackingContext, zserio_reader: zserio.BitStreamReader) -> None:
        self._age_ = zserio_context.age.read(zserio.array.BitFieldArrayTraits(8), zserio_reader)
        # check constraint
        if not (self._age_ <= 65):
            raise zserio.PythonRuntimeException("Constraint violated for field Employee.age!")
        ...
        self._salary_ = zserio_context.salary.read(zserio.array.BitFieldArrayTraits(16), zserio_reader)

        if zserio_reader.read_bool():
            self._bonus_ = zserio_context.bonus.read(zserio.array.BitFieldArrayTraits(16), zserio_reader)
        else:
            self._bonus_ = None

        self._role_ = tutorial.role.Role.from_reader_packed(zserio_context.role, zserio_reader)

        if self.is_skills_used():
            self._skills_ = zserio.array.Array.from_reader_packed(zserio.array.ObjectArrayTraits(self._ZserioElementFactory_skills()), zserio_reader, is_auto=True)
        else:
            self._skills_ = None
    ...
    def write_packed(self, zserio_context: Employee.ZserioPackingContext,
                     zserio_writer: zserio.BitStreamWriter) -> None:
        # check constraint
        if not (self._age_ <= 65):
            raise zserio.PythonRuntimeException("Constraint violated for field Employee.age!")
        zserio_context.age.write(zserio.array.BitFieldArrayTraits(8), zserio_writer, self._age_)

        zserio_writer.write_string(self._name_)

        zserio_context.salary.write(zserio.array.BitFieldArrayTraits(16), zserio_writer, self._salary_)

        if self.is_bonus_used():
            zserio_writer.write_bool(True)
            zserio_context.bonus.write(zserio.array.BitFieldArrayTraits(16), zserio_writer, self._bonus_)
        else:
            zserio_writer.write_bool(False)

        self._role_.write_packed(zserio_context.role, zserio_writer)
    ...
    class ZserioPackingContext:
        def __init__(self):
            ...
            self._salary_ = zserio.array.DeltaContext()
            self._bonus_ = zserio.array.DeltaContext()
            self._role_ = zserio.array.DeltaContext()
    ...
    class _ZserioElementFactory_skills:
        ...
        @staticmethod
        def create_packing_context() -> tutorial.experience.Experience.ZserioPackingContext:
            return tutorial.experience.Experience.ZserioPackingContext()

        @staticmethod
        def create_packed(zserio_context: tutorial.experience.Experience.ZserioPackingContext,
                          zserio_reader: zserio.BitStreamReader, zserio_index: int) -> tutorial.experience.Experience:
            del zserio_index
            return tutorial.experience.Experience.from_reader_packed(zserio_context, zserio_reader)

...
class Employee:
    ...
    def init_packing_context(self, zserio_context_node: zserio.array.PackingContextNode) -> None:
        zserio_context_node.children[0].context.init(zserio.array.BitFieldArrayTraits(8), self._age_)
        zserio_context_node.children[2].context.init(zserio.array.BitFieldArrayTraits(16), self._salary_)
        if self.is_bonus_used():
            zserio_context_node.children[3].context.init(zserio.array.BitFieldArrayTraits(16), self._bonus_)
    ...
    def bitsizeof_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        end_bitposition = bitposition
        end_bitposition += zserio_context_node.children[0].context.bitsizeof(zserio.array.BitFieldArrayTraits(8), self._age_)
        end_bitposition += zserio.bitsizeof.bitsizeof_string(self._name_)
        end_bitposition += zserio_context_node.children[2].context.bitsizeof(zserio.array.BitFieldArrayTraits(16), self._salary_)
        end_bitposition += 1
        if self.is_bonus_used():
            end_bitposition += zserio_context_node.children[3].context.bitsizeof(zserio.array.BitFieldArrayTraits(16), self._bonus_)
    ...
    def read_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        self._age_ = zserio_context_node.children[0].context.read(zserio.array.BitFieldArrayTraits(8), zserio_reader)
        # check constraint
        if not (self.age <= 65):
            raise zserio.PythonRuntimeException("Constraint violated for field Employee.age!")
        ...
        self._salary_ = zserio_context_node.children[2].context.read(zserio.array.BitFieldArrayTraits(16), zserio_reader)

        if zserio_reader.read_bool():
            self._bonus_ = zserio_context_node.children[3].context.read(zserio.array.BitFieldArrayTraits(16), zserio_reader)
    ...
    def write_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        if not (self.age <= 65):
            raise zserio.PythonRuntimeException("Constraint violated for field Employee.age!")
        zserio_context_node.children[0].context.write(zserio.array.BitFieldArrayTraits(8), zserio_writer, self._age_)

        zserio_writer.write_string(self._name_)

        zserio_context_node.children[2].context.write(zserio.array.BitFieldArrayTraits(16), zserio_writer, self._salary_)

        if self.is_bonus_used():
            zserio_writer.write_bool(True)
            zserio_context_node.children[3].context.write(zserio.array.BitFieldArrayTraits(16), zserio_writer, self._bonus_)
        else:
            zserio_writer.write_bool(False)

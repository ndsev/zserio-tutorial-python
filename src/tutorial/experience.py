...
class Experience:
    ...
    def init_packing_context(self, zserio_context_node: zserio.array.PackingContextNode) -> None:
        zserio_context_node.get_child_context(0).init(zserio.array.BitFieldArrayTraits(6), self._years_of_experience_)
    ...
    def bitsizeof_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        end_bitposition = bitposition
        end_bitposition += zserio_context_node.get_child_context(0).bitsizeof(zserio.array.BitFieldArrayTraits(6), self._years_of_experience_)
    ...
    def read_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        self._years_of_experience_ = zserio_context_node.get_child_context(0).read(zserio.array.BitFieldArrayTraits(6), zserio_reader)
    ...
    def write_packed(self, zserio_context_node: zserio.array.PackingContextNode,
        ...
        zserio_context_node.get_child_context(0).write(zserio.array.BitFieldArrayTraits(6), zserio_writer, self._years_of_experience_)
